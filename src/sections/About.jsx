            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-20 items-center">
                <div className="w-full md:w-1/2">
                    <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl rotate-[-3deg] hover:rotate-0 transition-transform duration-700">
                        <UnifiedImage
                            src={PROFILE_IMG}
                            alt={`About ${NAME}`}
                            className="w-full h-full object-cover bg-[#E8E6E3]"
                        />
                    </div>
                </div>
                <div className="w-full md:w-1/2 space-y-8">
                    <h2 className="text-5xl font-bold tracking-tight">
                        ...
                        <span className="text-[#20e0d0]">Through Code.</span>
                    </h2>
                    ...
                    <button
                        ...
                        className="group relative overflow-hidden bg-black text-white px-8 py-4 rounded-full font-bold mt-8"
                    >
